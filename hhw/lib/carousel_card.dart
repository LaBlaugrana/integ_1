...
import 'package:Hush/read_more_card.dart';
import 'package:Hush/read_more_card2.dart';
import 'package:Hush/read_more_card3.dart';
import 'package:Hush/read_more_card4.dart';
...
class Carousel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<List<String>> imgList = [
      ['images/card_carouse11.png',"A good night's sleep is\nlike a reset button for\nthe mind and body.", "0"],
      ['images/card_carouse11.png',"The Science of Sleep:\nUnveiling the Secrets\nto a Restful Night", "1"],
      ['images/card_carouse11.png',"The Impact of Sleep on\nMental Health: Exploring\nthe Vital Connection", "2"],
      ['images/card_carouse11.png',"Unlocking the Power of\nDreams: Exploring\nSleep and Dreams", "3"
      ],
    ];
